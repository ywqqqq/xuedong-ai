...
(function(vue) {
  ...
  function checkSanitizeDeprecation(opt) {
    if (opt && opt.sanitize && !opt.silent) {
      formatAppLog("warn", "at node_modules/marked/lib/marked.esm.js:295", "marked(): sanitize and sanitizer parameters are deprecated since version 0.7.0, should not be used and will be removed in the future. Read more here: https://marked.js.org/#/USING_ADVANCED.md#options");
    }
  }
      ...
      while (src) {
        ...
        if (src) {
          ...
          if (this.options.silent) {
            formatAppLog("error", "at node_modules/marked/lib/marked.esm.js:1707", errMsg);
            break;
          } else {
    ...
    inlineTokens(src, tokens = []) {
      ...
      while (src) {
        ...
        if (src) {
          const errMsg = "Infinite loop on byte: " + src.charCodeAt(0);
          if (this.options.silent) {
            formatAppLog("error", "at node_modules/marked/lib/marked.esm.js:1893", errMsg);
            break;
          } else {
            throw new Error(errMsg);
          }
...
`;
      ...
      for (i2 = 0; i2 < l; i2++) {
        ...
        switch (token.type) {
          ...
          default: {
            ...
            if (this.options.silent) {
              formatAppLog("error", "at node_modules/marked/lib/marked.esm.js:2390", errMsg);
              return;
            } else {
              throw new Error(errMsg);
            }
      ...
      for (i2 = 0; i2 < l; i2++) {
        ...
        switch (token.type) {
          ...
          default: {
            const errMsg = 'Token with "' + token.type + '" type was not found.';
            if (this.options.silent) {
              formatAppLog("error", "at node_modules/marked/lib/marked.esm.js:2469", errMsg);
              return;
            } else {
              throw new Error(errMsg);
            }
  ...
  var protocolFromUrl = function protocolFromUrl2(url) {
    var protocol2 = /^[\x00-\x20]*([^\\/#?]*?)(:|&#0*58|&#x0*3a|&colon)/i.exec(url);
    if (!protocol2) {
      return "_relative";
    }
    if (protocol2[2] !== ":") {
  ...
  class Settings {
    ...
    reportNonstrict(errorCode, errorMsg, token) {
      ...
      if (!strict || strict === "ignore") {
        ...
        typeof console !== "undefined" && formatAppLog("warn", "at node_modules/katex/dist/katex.mjs:478", "LaTeX-incompatible input and strict mode is set to 'warn': " + (errorMsg + " [" + errorCode + "]"));
      } else {
        typeof console !== "undefined" && formatAppLog("warn", "at node_modules/katex/dist/katex.mjs:481", "LaTeX-incompatible input and strict mode is set to " + ("unrecognized '" + strict + "': " + errorMsg + " [" + errorCode + "]"));
      }
    }
    /**
    ...
    useStrictBehavior(errorCode, errorMsg, token) {
      ...
      if (!strict || strict === "ignore") {
        ...
        typeof console !== "undefined" && formatAppLog("warn", "at node_modules/katex/dist/katex.mjs:514", "LaTeX-incompatible input and strict mode is set to 'warn': " + (errorMsg + " [" + errorCode + "]"));
        return false;
      } else {
        typeof console !== "undefined" && formatAppLog("warn", "at node_modules/katex/dist/katex.mjs:518", "LaTeX-incompatible input and strict mode is set to " + ("unrecognized '" + strict + "': " + errorMsg + " [" + errorCode + "]"));
        return false;
      }
    }
    /**
    ...
    isTrusted(context) {
      if (context.url && !context.protocol) {
        var protocol2 = utils.protocolFromUrl(context.url);
        if (protocol2 == null) {
          return false;
        }
  ...
  var makeSymbol = function makeSymbol2(value, fontName, mode, options, classes) {
    ...
    if (metrics) {
      ...
      typeof console !== "undefined" && formatAppLog("warn", "at node_modules/katex/dist/katex.mjs:5410", "No character metrics " + ("for '" + value + "' in style '" + fontName + "' and mode '" + mode + "'"));
  ...
  var makeSpan$2 = function makeSpan2(classes, children, options, style) {
  ...
  defineMacro("\\message", (context) => {
    ...
    formatAppLog("log", "at node_modules/katex/dist/katex.mjs:15432", arg.reverse().map((token) => token.text).join(""));
    return "";
  });
  defineMacro("\\errmessage", (context) => {
    var arg = context.consumeArgs(1)[0];
    formatAppLog("error", "at node_modules/katex/dist/katex.mjs:15438", arg.reverse().map((token) => token.text).join(""));
    return "";
  });
  defineMacro("\\show", (context) => {
    var tok = context.popToken();
    var name = tok.text;
    formatAppLog("log", "at node_modules/katex/dist/katex.mjs:15445", tok, context.macros.get(name), functions[name], symbols.math[name], symbols.text[name]);
    return "";
  });
  defineMacro("\\bgroup", "{");
  defineMacro("\\egroup", "}");
  ...
  if (typeof document !== "undefined") {
    if (document.compatMode !== "CSS1Compat") {
      typeof console !== "undefined" && formatAppLog("warn", "at node_modules/katex/dist/katex.mjs:18341", "Warning: KaTeX doesn't work in quirks mode. Make sure your website has a suitable doctype.");
  ...
  const _sfc_main$6 = {
    data() {
      return {
        ...
        // 当前正在播放的消息
        isRecordingSupported: !!uni.getRecorderManager,
        // 添加录音支持状态
        statusBarHeight: 0,
        _recordStartTime: 0,
        // 记录开始录音的时间
    ...
    methods: {
      ...
      startRecording() {
        ...
        formatAppLog("log", "at pages/index/index.vue:276", "开始录音");
        ...
        recorderManager.onStart(() => {
          formatAppLog("log", "at pages/index/index.vue:293", "录音开始");
          uni.vibrateShort({
            success: function() {
              formatAppLog("log", "at pages/index/index.vue:297", "震动成功");
            }
          });
        });
      },
      // 停止录音
      async stopRecording() {
        if (!this.isRecordingSupported || !this.isRecording)
          return;
        const recordingDuration = Date.now() - this._recordStartTime;
        if (recordingDuration < 1e3) {
          uni.showToast({
            title: "录音时间太短",
            icon: "none"
          });
      ...
      async callChatAPI(query, imageUrl = null) {
        try {
          formatAppLog("log", "at pages/index/index.vue:331", "Calling API with:", { query, imageUrl });
          ...
          formatAppLog("log", "at pages/index/index.vue:348", "API Response:", response);
          ...
          formatAppLog("error", "at pages/index/index.vue:359", "API调用错误：", error);
          throw error;
        }
      },
      // 添加确认输入的处理方法
      ...
      async sendMessage(input) {
        var _a;
        try {
          formatAppLog("log", "at pages/index/index.vue:374", "Input type:", typeof input);
          formatAppLog("log", "at pages/index/index.vue:375", "Input value:", input);
          formatAppLog("log", "at pages/index/index.vue:376", "Input detail:", input.detail);
          if (this.tempImage) {
          ...
          if (typeof input === "object") {
            messageContent = ((_a = input.detail) == null ? void 0 : _a.value) || this.inputText || "";
          } else {
          ...
          if (match) {
            ...
            if (searchContent) {
              ...
              let matchedIndex = 0;
              for (let i2 = 0; i2 < this.chatMessages.length; i2++) {
                if (this.chatMessages[i2].type === "ai") {
                  matchedIndex++;
                  if (matchedIndex === 2) {
                    matchedMessage = this.chatMessages[i2];
                    break;
                  }
                }
              }
...
${matchedMessage.content}`,
          ...
          formatAppLog("error", "at pages/index/index.vue:477", "发送消息失败:", error);
          uni.showToast({
            title: "发送失败",
            icon: "none"
          });
      ...
      async sendImageMessage() {
        try {
          ...
          formatAppLog("error", "at pages/index/index.vue:551", "图片消息发送失败:", error);
          this.isAiTyping = false;
          uni.hideLoading();
          uni.showToast({
      ...
      async uploadImage(filePath) {
        return new Promise((resolve, reject) => {
          const uploadTask = uni.uploadFile({
            ...
            success: (res) => {
              formatAppLog("log", "at pages/index/index.vue:574", "Upload response:", res);
              try {
                ...
                formatAppLog("error", "at pages/index/index.vue:583", "Parse response failed:", e, res.data);
                reject(new Error("解析响应数据失败"));
              }
            },
            fail: (err) => {
              formatAppLog("error", "at pages/index/index.vue:588", "Upload error:", err);
              reject(err);
            }
          });
          uploadTask.onProgressUpdate((res) => {
            formatAppLog("log", "at pages/index/index.vue:595", "上传进度：", res.progress);
            if (res.progress < 100) {
              uni.showLoading({
      ...
      // 监听滚动到底部事件
      onScrollToLower() {
        formatAppLog("log", "at pages/index/index.vue:625", "滚动到底部");
      },
      goToChatHistory() {
        ...
        setTimeout(() => {
          uni.navigateTo({
            ...
            fail: (err) => {
              formatAppLog("error", "at pages/index/index.vue:635", "导航失败：", err);
              uni.showToast({
                title: "页面跳转失败",
                icon: "none"
              });
      ...
      async handleVoiceRecord(tempFilePath) {
        try {
          ...
          formatAppLog("log", "at pages/index/index.vue:653", "开始处理语音文件:", tempFilePath);
          ...
          formatAppLog("log", "at pages/index/index.vue:666", "语音识别响应:", response);
          if (response.statusCode === 200) {
            try {
              formatAppLog("log", "at pages/index/index.vue:671", "原始响应数据:", response.data);
              let result;
              ...
              formatAppLog("log", "at pages/index/index.vue:681", "解析后的数据:", result);
              if (result.success) {
                ...
                formatAppLog("log", "at pages/index/index.vue:695", "识别到的文本:", result.text);
                this.inputText = result.text;
                await this.sendMessage(result.text);
              } else {
                formatAppLog("error", "at pages/index/index.vue:702", "语音识别失败:", result);
                throw new Error("语音识别失败");
              }
            } catch (e) {
              formatAppLog("error", "at pages/index/index.vue:706", "解析响应数据失败:", e);
              formatAppLog("error", "at pages/index/index.vue:707", "原始响应数据:", response.data);
              throw new Error("解析语音识别结果失败");
            }
          } else {
            formatAppLog("error", "at pages/index/index.vue:711", "请求失败:", response.statusCode, response.data);
            throw new Error(`语音识别请求失败: ${response.statusCode}`);
          }
        } catch (error) {
          formatAppLog("error", "at pages/index/index.vue:716", "语音处理失败:", error);
          uni.showToast({
      ...
      playVoiceMessage(message) {
        ...
        audioManager.onError((res) => {
          formatAppLog("error", "at pages/index/index.vue:755", "语音播放失败:", res);
          this.currentPlayingAudio = null;
          uni.showToast({
            title: "播放失败",
            icon: "none"
      ...
      // 添加加载更多历史消息的方法
      loadMoreHistory() {
        formatAppLog("log", "at pages/index/index.vue:803", "Loading more history...");
      },
      // 处理下拉刷新
      async onRefresh() {
        ...
        try {
          content = content.replace(/\$\$(.*?)\$\$/g, (match, formula) => {
            try {
              ...
              formatAppLog("warn", "at pages/index/index.vue:834", "Math formula rendering failed:", e);
              return match;
            }
            ...
            try {
              ...
              formatAppLog("warn", "at pages/index/index.vue:844", "Math formula rendering failed:", e);
              return match;
            }
          });
          ...
          html = html.replace(/<pre><code>/g, '<pre><code class="code-block">').replace(/<table>/g, '<table class="md-table">');
          return html;
        } catch (error) {
          formatAppLog("warn", "at pages/index/index.vue:871", "Markdown parsing warning:", error);
      ...
      async playAIResponse(msg) {
        try {
          ...
          const response = await uni.request({
            url: "http://10.65.1.110:8002/api/tts",
            // 替换为实际的 API 地址
            method: "POST",
            data: {
              text: msg.content
          ...
          if (response.statusCode === 200 && response.data.file_url) {
            ...
            formatAppLog("error", "at pages/index/index.vue:928", "语音转换失败:", response);
            uni.showToast({
              title: "语音转换失败",
              icon: "none"
            });
          ...
          audioManager.onError((res) => {
            formatAppLog("error", "at pages/index/index.vue:943", "Audio playback error:", res);
            msg.isPlaying = false;
            this.currentPlayingMsg = null;
            uni.showToast({
              title: "音频播放失败",
          ...
          formatAppLog("error", "at pages/index/index.vue:958", "音频播放错误：", error);
          uni.showToast({
            title: "音频播放失败",
            icon: "none"
          });
      ...
      askSuggestion(suggestion) {
        if (!suggestion)
          return;
        formatAppLog("log", "at pages/index/index.vue:972", "选择了建议问题:", suggestion);
      ...
      async loadSessionMessages(sessionId) {
        ...
        try {
              ...
              if (msg.role === "user") {
                if (Array.isArray(msg.content) && msg.content.length > 0) {
                  ...
                  return {
                    ...
                    image: imageContent ? imageContent.url : void 0
                  };
                }
                return {
                  ...baseMessage,
          ...
          formatAppLog("error", "at pages/index/index.vue:1085", "加载会话消息失败:", error);
          uni.showToast({
            title: "加载消息失败",
            icon: "none"
          });
      ...
      goToFuzzyKnowledge() {
        ...
        setTimeout(() => {
          uni.navigateTo({
            ...
            fail: (err) => {
              formatAppLog("error", "at pages/index/index.vue:1100", "导航失败：", err);
              uni.showToast({
                title: "页面跳转失败",
                icon: "none"
              });
      ...
      goToDailyQuestion() {
        ...
        setTimeout(() => {
          uni.navigateTo({
            ...
            fail: (err) => {
              formatAppLog("error", "at pages/index/index.vue:1115", "导航失败：", err);
              uni.showToast({
                title: "页面跳转失败",
                icon: "none"
              });
      ...
      playPreview() {
        ...
        audioManager.onError((res) => {
          formatAppLog("error", "at pages/index/index.vue:1147", "试听播放失败:", res);
          this.isPreviewPlaying = false;
          uni.showToast({
            title: "播放失败",
            icon: "none"
      ...
      async confirmVoiceSubmit() {
        ...
        try {
          ...
          const userMessage = {
            ...
            duration: Math.ceil((Date.now() - this._recordStartTime) / 1e3),
            // 将毫秒转换为秒并向上取整
            time: Date.now()
          };
          this.chatMessages.push(userMessage);
          ...
          formatAppLog("error", "at pages/index/index.vue:1225", "语音对话失败:", error);
          uni.showToast({
            title: error.message || "发送失败",
            icon: "none"
          });
      ...
      async startNewChat(skipConfirm = false) {
        try {
          ...
          try {
            ...
            formatAppLog("error", "at pages/index/index.vue:1293", "创建新会话失败:", error);
          ...
          formatAppLog("error", "at pages/index/index.vue:1310", "开始新对话失败:", error);
          uni.showToast({
            title: "操作失败",
            icon: "none"
          });
      ...
      async handleLogout() {
        try {
          ...
          formatAppLog("error", "at pages/index/index.vue:1360", "退出登录失败:", error);
          uni.showToast({
            title: "操作失败",
            icon: "none"
          });
    ...
    onLoad(options) {
      ...
      if (options.sessionId) {
        formatAppLog("log", "at pages/index/index.vue:1377", "Loading session:", options.sessionId);
        this.sessionId = options.sessionId;
        this.loadSessionMessages(options.sessionId);
      }
      if (this.isRecordingSupported && recorderManager) {
        recorderManager.onStart(() => {
          formatAppLog("log", "at pages/index/index.vue:1388", "录音开始");
          this._recordStartTime = Date.now();
        });
        recorderManager.onStop(async (res) => {
          formatAppLog("log", "at pages/index/index.vue:1394", "录音结束:", res);
          const duration = Date.now() - this._recordStartTime;
          formatAppLog("log", "at pages/index/index.vue:1396", "录音时长:", duration, "ms");
          if (res.tempFilePath) {
            try {
              const fileInfo = await uni.getFileInfo({
                filePath: res.tempFilePath
              });
              formatAppLog("log", "at pages/index/index.vue:1403", "录音文件信息:", fileInfo);
              ...
              formatAppLog("error", "at pages/index/index.vue:1418", "获取录音文件信息失败:", error);
              uni.showToast({
                title: "录音失败，请重试",
                icon: "none"
              });
            ...
            formatAppLog("error", "at pages/index/index.vue:1425", "未获取到录音文件路径");
            uni.showToast({
              title: "录音失败",
              icon: "none"
            });
        ...
        recorderManager.onError((res) => {
          formatAppLog("error", "at pages/index/index.vue:1435", "录音错误:", res);
          this.isRecording = false;
          this.showVoiceBtn = false;
          uni.showToast({
        ...
        recorderManager.onStart(() => {
          formatAppLog("log", "at pages/index/index.vue:1446", "录音开始");
        });
      }
    ...
    return vue.openBlock(), vue.createElementBlock(
      ...
      [
        ...
        vue.createElementVNode(
          ...
          [
            vue.createElementVNode("view", { class: "sidebar-header" }, [
              ...
              vue.createElementVNode("text", { class: "user-name" }, "懵懂小学生tty")
            ]),
            vue.createElementVNode("view", { class: "sidebar-content" }, [
              vue.createElementVNode("view", {
                class: "sidebar-item",
                onClick: _cache[0] || (_cache[0] = vue.withModifiers((...args) => $options.goToChatHistory && $options.goToChatHistory(...args), ["stop"]))
              }, [
                vue.createElementVNode("text", { class: "sidebar-icon" }, "📝"),
                vue.createElementVNode("text", null, "聊天记录")
              ]),
              vue.createElementVNode("view", {
                class: "sidebar-item",
                onClick: _cache[1] || (_cache[1] = vue.withModifiers((...args) => $options.goToFuzzyKnowledge && $options.goToFuzzyKnowledge(...args), ["stop"]))
              }, [
                vue.createElementVNode("text", { class: "sidebar-icon" }, "📚"),
                vue.createElementVNode("text", null, "模糊知识")
              ]),
              vue.createElementVNode("view", {
                class: "sidebar-item",
                onClick: _cache[2] || (_cache[2] = vue.withModifiers((...args) => $options.goToDailyQuestion && $options.goToDailyQuestion(...args), ["stop"]))
              }, [
                vue.createElementVNode("text", { class: "sidebar-icon" }, "📅"),
                vue.createElementVNode("text", null, "每日一题")
              ]),
              vue.createElementVNode("view", { class: "sidebar-item" }, [
                vue.createElementVNode("text", { class: "sidebar-icon" }, "⚙️"),
                vue.createElementVNode("text", null, "设置")
              ]),
              vue.createElementVNode("view", {
                class: "sidebar-item",
                onClick: _cache[3] || (_cache[3] = vue.withModifiers((...args) => $options.handleLogout && $options.handleLogout(...args), ["stop"]))
              }, [
                vue.createElementVNode("text", { class: "sidebar-icon" }, "🚪"),
        ...
        $data.showSidebar ? (vue.openBlock(), vue.createElementBlock("view", {
          key: 0,
          class: "mask",
          onClick: _cache[4] || (_cache[4] = (...args) => $options.toggleSidebar && $options.toggleSidebar(...args))
        })) : vue.createCommentVNode("v-if", true),
        vue.createCommentVNode(" 顶部状态栏 "),
        vue.createElementVNode("view", { class: "header" }, [
          vue.createElementVNode("view", {
            class: "left",
            onClick: _cache[5] || (_cache[5] = (...args) => $options.toggleSidebar && $options.toggleSidebar(...args))
          }, [
            vue.createElementVNode("text", { class: "menu-icon" }, "☰")
          ]),
          vue.createElementVNode("view", { class: "center" }, [
            vue.createElementVNode("text", { class: "title" }, "AI-teacher")
          ]),
          vue.createElementVNode("view", { class: "right" }, [
            vue.createElementVNode("text", { class: "icon" }, "🔇"),
            vue.createElementVNode("text", {
              class: "icon",
              onClick: _cache[6] || (_cache[6] = ($event) => $options.startNewChat(false))
            }, "🔄")
          ])
        ]),
        ...
        vue.createElementVNode("scroll-view", {
          ...
          onScroll: _cache[11] || (_cache[11] = (...args) => $options.onScroll && $options.onScroll(...args)),
          onScrolltolower: _cache[12] || (_cache[12] = (...args) => $options.onScrollToLower && $options.onScrollToLower(...args)),
          "refresher-enabled": "",
          ...
          vue.createCommentVNode(" AI头像和欢迎消息 "),
          $data.chatMessages.length === 0 ? (vue.openBlock(), vue.createElementBlock("view", {
            key: 0,
            ...
            vue.createElementVNode("view", { class: "message-content" }, [
              vue.createElementVNode("text", null, "你好，我是AI老师。")
            ])
          ])) : vue.createCommentVNode("v-if", true),
          ...
          (vue.openBlock(true), vue.createElementBlock(
            ...
            vue.renderList($data.chatMessages, (msg, index) => {
              return vue.openBlock(), vue.createElementBlock(
                ...
                {
                  key: index,
                  class: vue.normalizeClass(["message", msg.type === "user" ? "user-message" : "ai-message"])
                },
                [
                  msg.type === "ai" ? (vue.openBlock(), vue.createElementBlock("image", {
                    key: 0,
                    class: "avatar",
                    src: "/static/ai-avatar.png"
                  })) : vue.createCommentVNode("v-if", true),
                  vue.createElementVNode("view", {
                    class: vue.normalizeClass(["message-content", { "voice-message": msg.messageType === "voice" }]),
                    onClick: ($event) => msg.messageType === "voice" && $options.playVoiceMessage(msg)
                  }, [
                    vue.createCommentVNode(" 图片消息 "),
                    msg.image ? (vue.openBlock(), vue.createElementBlock("image", {
                      key: 0,
                      src: msg.image,
                      class: "message-image",
                      mode: "widthFix",
                      onClick: ($event) => $options.previewImage(msg.image)
                    }, null, 8, ["src", "onClick"])) : vue.createCommentVNode("v-if", true),
                    vue.createCommentVNode(" AI回复使用markdown渲染 "),
                    msg.type === "ai" && !msg.messageType ? (vue.openBlock(), vue.createElementBlock("view", {
                      key: 1,
                      class: "ai-response"
                    }, [
                      vue.createElementVNode("rich-text", {
                        nodes: $options.formatMarkdown(msg.content),
                        class: "markdown-content"
                      }, null, 8, ["nodes"]),
                      vue.createElementVNode("view", {
                        class: "ai-voice-control",
                        onClick: vue.withModifiers(($event) => $options.playAIResponse(msg), ["stop"])
                      }, [
                        vue.createElementVNode(
                          "text",
                          { class: "voice-icon" },
                          vue.toDisplayString(msg.isPlaying ? "⏸️" : "🔊"),
                          1
                          /* TEXT */
                        ),
                        vue.createElementVNode(
                          "text",
                          { class: "voice-text" },
                          vue.toDisplayString(msg.isPlaying ? "暂停" : "播放语音"),
                          1
                          /* TEXT */
                        )
                      ], 8, ["onClick"]),
                      msg.followUpSuggestions && msg.followUpSuggestions.length ? (vue.openBlock(), vue.createElementBlock("view", {
                        key: 0,
                        class: "follow-up-suggestions"
                      }, [
                        vue.createElementVNode("text", { class: "suggestions-title" }, "建议继续问："),
                        (vue.openBlock(true), vue.createElementBlock(
                          vue.Fragment,
                          null,
                          vue.renderList(msg.followUpSuggestions, (suggestion, index2) => {
                            return vue.openBlock(), vue.createElementBlock("view", {
                              key: index2,
                              class: "suggestion-item",
                              onClick: ($event) => $options.askSuggestion(suggestion)
                            }, [
                              vue.createElementVNode(
                                "text",
                    ...
                    ])) : !msg.messageType ? (vue.openBlock(), vue.createElementBlock(
                      vue.Fragment,
                      { key: 2 },
                      [
                        vue.createCommentVNode(" 用户消息仍然使用普通文本 "),
                        vue.createElementVNode(
                          "text",
                          null,
                    ...
                    )) : msg.messageType === "voice" ? (vue.openBlock(), vue.createElementBlock(
                      vue.Fragment,
                      { key: 3 },
                      [
                        vue.createCommentVNode(" 语音消息 "),
                        vue.createElementVNode("view", { class: "voice-content" }, [
                          ...
                          $data.currentPlayingAudio === msg.content ? (vue.openBlock(), vue.createElementBlock("text", {
                            key: 0,
                  ...
                  msg.type === "user" ? (vue.openBlock(), vue.createElementBlock("image", {
                    key: 1,
                    class: "avatar",
          ...
          vue.createCommentVNode(" 显示正在输入状态 "),
          $data.isAiTyping ? (vue.openBlock(), vue.createElementBlock("view", {
            key: 1,
            class: "message ai-message"
          }, [
            vue.createElementVNode("image", {
            ...
            vue.createElementVNode("view", { class: "message-content typing" }, [
              vue.createElementVNode("text", null, "正在输入...")
            ])
          ])) : vue.createCommentVNode("v-if", true),
          vue.createCommentVNode(" 图片预览区域 "),
          $data.tempImage ? (vue.openBlock(), vue.createElementBlock("view", {
            key: 2,
            class: "preview-area"
          }, [
            vue.createElementVNode("view", { class: "preview-wrapper" }, [
              ...
              vue.createElementVNode("view", {
                class: "preview-close",
                onClick: _cache[7] || (_cache[7] = (...args) => $options.clearImage && $options.clearImage(...args))
              }, "×")
            ])
          ])) : vue.createCommentVNode("v-if", true),
          vue.createCommentVNode(" 在语音输入区域添加试听界面 "),
          $data.isPreviewingVoice ? (vue.openBlock(), vue.createElementBlock("view", {
            key: 3,
            class: "voice-preview"
          }, [
            vue.createElementVNode("view", { class: "preview-controls" }, [
              vue.createElementVNode(
                "button",
                {
                  class: vue.normalizeClass(["preview-btn", { "playing": $data.isPreviewPlaying }]),
                  onClick: _cache[8] || (_cache[8] = (...args) => $options.playPreview && $options.playPreview(...args))
                },
                vue.toDisplayString($data.isPreviewPlaying ? "停止" : "试听"),
                3
                /* TEXT, CLASS */
              ),
              vue.createElementVNode("button", {
                class: "submit-btn",
                onClick: _cache[9] || (_cache[9] = (...args) => $options.confirmVoiceSubmit && $options.confirmVoiceSubmit(...args))
              }, "确认发送"),
              vue.createElementVNode("button", {
                class: "cancel-btn",
                onClick: _cache[10] || (_cache[10] = (...args) => $options.cancelVoiceSubmit && $options.cancelVoiceSubmit(...args))
              }, "取消")
            ])
          ])) : vue.createCommentVNode("v-if", true)
        ...
        vue.createElementVNode("view", { class: "footer" }, [
          vue.createCommentVNode(" 正常工具栏 "),
          !$data.isRecording && !$data.showVoiceBtn ? (vue.openBlock(), vue.createElementBlock("view", {
            key: 0,
            class: "tool-bar"
          }, [
            vue.createElementVNode("view", {
              class: "tool-item",
              onClick: _cache[14] || (_cache[14] = (...args) => $options.takePhoto && $options.takePhoto(...args))
            }, [
              vue.createCommentVNode(' <image class="tool-icon" src="/static/camera.png"></image> '),
              vue.createElementVNode("text", null, "拍照解题")
            ]),
            vue.createElementVNode("view", { class: "tool-item" }, [
              vue.createCommentVNode(' <image class="tool-icon" src="/static/phone.png"></image> '),
              vue.createElementVNode("text", null, "打电话")
            ]),
            vue.createElementVNode("view", { class: "tool-item" }, [
              vue.createCommentVNode(' <image class="tool-icon" src="/static/translate.png"></image> '),
              vue.createElementVNode("text", null, "针对出题")
            ]),
            vue.createElementVNode("view", { class: "tool-item" }, [
              vue.createCommentVNode(' <image class="tool-icon" src="/static/write.png"></image> '),
              vue.createElementVNode("text", null, "写作")
            ])
          ])) : vue.createCommentVNode("v-if", true),
          vue.createCommentVNode(" 输入区域 "),
          !$data.showVoiceBtn ? (vue.openBlock(), vue.createElementBlock("view", {
            key: 1,
            class: "input-area"
          }, [
            !$data.inputText && $data.isRecordingSupported ? (vue.openBlock(), vue.createElementBlock("text", {
              key: 0,
              class: "mic-icon",
              onClick: _cache[15] || (_cache[15] = (...args) => $options.showVoiceInput && $options.showVoiceInput(...args))
            }, "🎤")) : vue.createCommentVNode("v-if", true),
            vue.withDirectives(vue.createElementVNode(
              "input",
              {
                type: "text",
                "onUpdate:modelValue": _cache[16] || (_cache[16] = ($event) => $data.inputText = $event),
                placeholder: "有什么问题尽管问我",
                class: "chat-input",
                onConfirm: _cache[17] || (_cache[17] = (...args) => $options.handleConfirm && $options.handleConfirm(...args))
              },
              null,
              544
            ...
            !$data.inputText ? (vue.openBlock(), vue.createElementBlock(
              vue.Fragment,
              { key: 1 },
              [
                vue.createElementVNode("text", {
                  class: "plus-icon",
                  onClick: _cache[18] || (_cache[18] = (...args) => $options.showImageOptions && $options.showImageOptions(...args))
                }, "+"),
              ...
              key: 2,
              class: "send-btn",
              onClick: _cache[19] || (_cache[19] = (...args) => $options.sendMessage && $options.sendMessage(...args))
            }, "发送"))
            ...
            [
              ...
              vue.createElementVNode(
                "view",
                {
                  ...
                  onTouchstart: _cache[21] || (_cache[21] = (...args) => $options.startRecording && $options.startRecording(...args)),
                  onTouchend: _cache[22] || (_cache[22] = (...args) => $options.stopRecording && $options.stopRecording(...args)),
                  onTouchcancel: _cache[23] || (_cache[23] = (...args) => $options.cancelRecording && $options.cancelRecording(...args))
                },
                [
                  vue.createElementVNode(
                    "text",
                    {
                      class: vue.normalizeClass(["voice-btn", { "recording": $data.isRecording }])
                    },
                  ...
                  vue.createElementVNode("text", {
                    class: "cancel-voice",
                    onClick: _cache[20] || (_cache[20] = (...args) => $options.cancelVoiceInput && $options.cancelVoiceInput(...args))
                  }, "取消")
                ],
                32
                /* HYDRATE_EVENTS */
  ...
  const PagesIndexIndex = /* @__PURE__ */ _export_sfc(_sfc_main$6, [["render", _sfc_render$5], ["__file", "C:/Users/admin/Documents/HBuilderProjects/ai-teacher/pages/index/index.vue"]]);
  const _sfc_main$5 = {
    data() {
      return {
        chatList: [],
    ...
    methods: {
      ...
      async loadChatHistory() {
        try {
          ...
          formatAppLog("error", "at pages/chat-history/chat-history.vue:54", "获取聊天记录失败:", error);
          uni.showToast({
            title: "获取聊天记录失败",
            icon: "none"
          });
      ...
      openChat(chat) {
        uni.navigateTo({
          ...
          fail: (err) => {
            formatAppLog("error", "at pages/chat-history/chat-history.vue:91", "导航失败：", err);
            uni.showToast({
              title: "页面跳转失败",
              icon: "none"
            });
  ...
  function _sfc_render$4(_ctx, _cache, $props, $setup, $data, $options) {
    return vue.openBlock(), vue.createElementBlock("view", { class: "container" }, [
      vue.createElementVNode("scroll-view", {
        ...
        $data.chatList.length === 0 ? (vue.openBlock(), vue.createElementBlock("view", {
          key: 0,
          class: "empty-state"
        }, [
            ...
            return vue.openBlock(), vue.createElementBlock("view", {
              ...
              vue.createElementVNode("view", { class: "chat-info" }, [
                vue.createElementVNode(
                  "text",
                  { class: "chat-title" },
                  vue.toDisplayString(chat.preview),
                  1
                  /* TEXT */
                ),
                vue.createElementVNode(
                  "text",
                  { class: "chat-time" },
                  vue.toDisplayString($options.formatTime(chat.start_time)),
                  1
                  /* TEXT */
                )
              ]),
              vue.createElementVNode(
                "text",
                { class: "chat-preview" },
                "共 " + vue.toDisplayString(chat.message_count) + " 条对话",
                1
                /* TEXT */
              )
            ], 8, ["onClick"]);
  ...
  const PagesChatHistoryChatHistory = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["render", _sfc_render$4], ["__file", "C:/Users/admin/Documents/HBuilderProjects/ai-teacher/pages/chat-history/chat-history.vue"]]);
  const _sfc_main$4 = {
    data() {
      return {
        knowledgeList: [
          {
            ...
            time: (/* @__PURE__ */ new Date("2024-01-10")).getTime(),
            frequency: 5
          },
          {
            title: "函数基础",
            content: "函数是描述两个变量之间对应关系的数学概念。重点包括：\n• 函数的定义域和值域\n• 函数的性质（单调性、奇偶性）\n• 基本初等函数的图像特征\n• 复合函数与反函数",
            time: (/* @__PURE__ */ new Date("2024-01-09")).getTime(),
            frequency: 4
          },
          {
            title: "导数",
            content: "导数表示函数在某一点的变化率。核心内容：\n• 导数的定义和几何意义\n• 基本求导法则\n• 复合函数求导\n• 导数在实际问题中的应用",
            time: (/* @__PURE__ */ new Date("2024-01-08")).getTime(),
            frequency: 2
          },
          {
            title: "积分",
            content: "积分是微积分中的重要概念，用于计算曲线下的面积。包括：\n• 定积分和不定积分的概念\n• 基本积分公式\n• 换元积分法和分部积分法\n• 积分在面积和体积计算中的应用",
            time: (/* @__PURE__ */ new Date("2024-01-07")).getTime(),
            frequency: 2
          },
          {
            title: "概率",
            content: "概率用于描述随机事件发生的可能性。主要内容：\n• 随机事件与概率的定义\n• 古典概型与几何概型\n• 条件概率与全概率公式\n• 概率在统计分析中的应用",
            time: (/* @__PURE__ */ new Date("2024-01-06")).getTime(),
            frequency: 1
          }
        ]
      };
    ...
    methods: {
      formatTime(timestamp) {
        ...
        const daysDiff = Math.floor((today - targetDate) / (1e3 * 60 * 60 * 24));
        if (daysDiff === 0) {
          return "今天";
        } else if (daysDiff === 1) {
          return "昨天";
    ...
    return vue.openBlock(), vue.createElementBlock("view", { class: "container" }, [
      vue.createElementVNode("view", { class: "knowledge-list" }, [
        (vue.openBlock(true), vue.createElementBlock(
          vue.Fragment,
          null,
          vue.renderList($data.knowledgeList, (item, index) => {
            return vue.openBlock(), vue.createElementBlock(
              "view",
              {
                key: index,
                class: "knowledge-item",
                style: vue.normalizeStyle($options.getFrequencyStyle(item.frequency))
              },
              [
                vue.createElementVNode("view", { class: "knowledge-content" }, [
                  vue.createElementVNode(
                    "text",
  ...
  const PagesFuzzyKnowledgeFuzzyKnowledge = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["render", _sfc_render$3], ["__file", "C:/Users/admin/Documents/HBuilderProjects/ai-teacher/pages/fuzzy-knowledge/fuzzy-knowledge.vue"]]);
  const _sfc_main$3 = {
    data() {
      return {
        question: "",
    ...
    methods: {
      ...
      async loadQuestion() {
        ...
        try {
          ...
          formatAppLog("error", "at pages/daily-question/daily-question.vue:156", "加载题目失败:", error);
          uni.showToast({
            title: "加载题目失败",
            icon: "none"
          });
      ...
      chooseImage() {
        uni.chooseImage({
          ...
          fail: (err) => {
            formatAppLog("error", "at pages/daily-question/daily-question.vue:175", "选择图片失败:", err);
            uni.showToast({
              title: "选择图片失败",
              icon: "none"
            });
      ...
      async submitAnswer() {
        ...
        try {
          ...
          formatAppLog("error", "at pages/daily-question/daily-question.vue:223", "提交答案失败:", error);
          uni.showToast({
            title: "提交失败",
            icon: "none"
          });
  ...
  function _sfc_render$2(_ctx, _cache, $props, $setup, $data, $options) {
    return vue.openBlock(), vue.createElementBlock("view", { class: "container" }, [
      vue.createCommentVNode(" 题目卡片 "),
      vue.createElementVNode("view", { class: "question-card" }, [
        vue.createElementVNode("view", { class: "card-header" }, [
          vue.createElementVNode("text", { class: "title" }, "每日一题"),
          vue.createElementVNode(
            "text",
            { class: "date" },
            vue.toDisplayString($options.formatDate()),
            1
            /* TEXT */
          )
        ]),
        vue.createElementVNode("view", { class: "knowledge-points" }, [
          (vue.openBlock(true), vue.createElementBlock(
            vue.Fragment,
            null,
            vue.renderList($data.knowledgePoints, (point, index) => {
              return vue.openBlock(), vue.createElementBlock(
                "text",
                {
                  class: "tag",
      ...
      vue.createCommentVNode(" 答题区域 "),
      vue.createElementVNode("view", { class: "answer-area" }, [
        !$data.answerImage ? (vue.openBlock(), vue.createElementBlock("view", {
          key: 0,
          class: "upload-box",
          onClick: _cache[0] || (_cache[0] = (...args) => $options.chooseImage && $options.chooseImage(...args))
        }, [
          vue.createElementVNode("text", { class: "upload-icon" }, "📷"),
          vue.createElementVNode("text", { class: "upload-text" }, "点击上传答题图片")
          ...
          vue.createElementVNode("text", {
            class: "delete-btn",
            onClick: _cache[2] || (_cache[2] = vue.withModifiers((...args) => $options.deleteImage && $options.deleteImage(...args), ["stop"]))
          }, "×")
        ]))
      ]),
      vue.createCommentVNode(" 添加解析和答案区域 "),
      $data.showSolution ? (vue.openBlock(), vue.createElementBlock("view", {
        key: 0,
        class: "solution-area"
      }, [
        vue.createElementVNode("view", { class: "solution-card" }, [
          vue.createElementVNode("view", { class: "solution-header" }, [
            vue.createElementVNode("text", { class: "solution-title" }, "解析")
          ]),
          vue.createElementVNode("view", { class: "solution-content" }, [
            vue.createElementVNode(
              "text",
              null,
        ...
        vue.createElementVNode("view", { class: "solution-card" }, [
          vue.createElementVNode("view", { class: "solution-header" }, [
            vue.createElementVNode("text", { class: "solution-title" }, "答案")
          ]),
          vue.createElementVNode("view", { class: "solution-content" }, [
            vue.createElementVNode(
              "text",
      ...
      !$data.showSolution ? (vue.openBlock(), vue.createElementBlock("button", {
        key: 1,
        class: vue.normalizeClass(["submit-btn", { "disabled": !$data.answerImage }]),
        disabled: !$data.answerImage,
        onClick: _cache[3] || (_cache[3] = (...args) => $options.submitAnswer && $options.submitAnswer(...args))
      }, " 提交答案 ", 10, ["disabled"])) : vue.createCommentVNode("v-if", true)
    ]);
  }
  const PagesDailyQuestionDailyQuestion = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["render", _sfc_render$2], ["__file", "C:/Users/admin/Documents/HBuilderProjects/ai-teacher/pages/daily-question/daily-question.vue"]]);
  const _sfc_main$2 = {
    data() {
      return {
        username: "",
      ...
      handleLogin() {
        ...
        if (this.username === "tty" && this.password === "123456") {
          ...
          uni.reLaunch({
            ...
            fail: (error) => {
              formatAppLog("error", "at pages/login/login.vue:79", "页面跳转失败:", error);
              uni.hideLoading();
              uni.showToast({
                title: "登录失败",
                icon: "none"
    ...
    return vue.openBlock(), vue.createElementBlock("view", { class: "container" }, [
      ...
      vue.createElementVNode("view", { class: "form" }, [
        ...
        vue.createElementVNode("view", {
          ...
          vue.createElementVNode("text", null, "还没有账号？立即注册")
        ])
      ])
    ]);
  }
  const PagesLoginLogin = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["render", _sfc_render$1], ["__file", "C:/Users/admin/Documents/HBuilderProjects/ai-teacher/pages/login/login.vue"]]);
  const _sfc_main$1 = {
    data() {
      return {
        username: "",
  ...
  const PagesRegisterRegister = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["render", _sfc_render], ["__file", "C:/Users/admin/Documents/HBuilderProjects/ai-teacher/pages/register/register.vue"]]);
  __definePage("pages/index/index", PagesIndexIndex);
  __definePage("pages/chat-history/chat-history", PagesChatHistoryChatHistory);
  __definePage("pages/fuzzy-knowledge/fuzzy-knowledge", PagesFuzzyKnowledgeFuzzyKnowledge);
  __definePage("pages/daily-question/daily-question", PagesDailyQuestionDailyQuestion);
  ...
  const App = /* @__PURE__ */ _export_sfc(_sfc_main, [["__file", "C:/Users/admin/Documents/HBuilderProjects/ai-teacher/App.vue"]]);
  function createApp() {
